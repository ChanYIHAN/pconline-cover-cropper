...
- **Heading Font:** Segoe UI Variable / PingFang SC
- **Body Font:** Segoe UI Variable / PingFang SC
- **Mood:** professional, editorial, precise, readable
- **Loading rule:** system fonts only, preserving the product's fully offline and private workflow
...
**Pattern Name:** Three-pane Pro Editor Workbench

- **Primary flow:** Library → focused canvas → inspector and delivery
- **CTA Placement:** persistent delivery dock at the bottom of the inspector
